            ...
            {status==="idle" && (
              <div style={{ textAlign:"center", padding:"60px 20px" }}>
                ...
                <div style={{ fontSize:13, color:"#334155", marginTop:8 }}>
                  205 stocks · SGD ≥200M · 15 sectors · top-5 scoring · STI benchmark · Yahoo Finance data
                </div>
              </div>
            )}
